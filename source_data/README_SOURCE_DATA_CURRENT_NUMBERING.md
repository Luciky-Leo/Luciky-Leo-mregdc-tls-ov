...
- Fig. 2 source tables cover marker and feature matrices supporting the current scRNA mregDC program. CellChat and pseudotime object-level outputs are documented in the reproducibility workflow and should be regenerated from the scripted single-cell analysis if panel-level rerendering is requested.
...
- Code/source-data packaging is reviewer-facing. Public repository and archival DOI are provided in the manuscript data-availability statement and upload README.
