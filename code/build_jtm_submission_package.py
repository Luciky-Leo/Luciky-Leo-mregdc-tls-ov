...
def main() -> None:
    ...
    (OUT / "code" / "README_CODE_AVAILABILITY.md").write_text(
        ...
        "This folder contains the reproducible manuscript-assembly script used to create the Journal of Translational Medicine/Springer Nature LaTeX package. "
        "Computational analysis scripts and run manifests are retained in the project analysis directories under E:/Reserch/MregDC and are available for peer review on request. "
        "Before publication, these scripts should be deposited in a stable public repository and the DOI/URL should replace the placeholder language in the manuscript.\n",
        encoding="utf-8",
    )
